...
class TestClave {
	...
	void setUp() throws Exception {
		FichaCodificadora[] miCombinacion = {FichaCodificadora.ROJO,FichaCodificadora.BLANCO,FichaCodificadora.AZUL,
		FichaCodificadora.VERDE,FichaCodificadora.NARANJA};
	...
	@Test
	void probarQueLaPrimeraFichaEsBlanco() throws Exception {
	...
	void probarQueSiLaClaveTieneMasDeCincoElementosNoCargaLaClave() throws Exception {
		FichaCodificadora[] miCombinacion = {FichaCodificadora.ROJO,FichaCodificadora.BLANCO,FichaCodificadora.AZUL,
		FichaCodificadora.VERDE,FichaCodificadora.NARANJA,FichaCodificadora.NARANJA};
		miClave = new Clave(miCombinacion);
	...
	@Test
	void cargarMenosDeCincoElementosDevuelveaClaveNoCompleta() {
		FichaCodificadora[] miCombinacion = {FichaCodificadora.ROJO,FichaCodificadora.BLANCO,FichaCodificadora.AZUL,
		FichaCodificadora.VERDE};
		miClave = new Clave(miCombinacion);
